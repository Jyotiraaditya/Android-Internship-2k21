...
public class MainActivity extends AppCompatActivity {
    ...
    FirebaseAuth auth;
    /*To fet the otp for automatic verification and to capture the failed cases*/
        ...
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationCompleted(@NonNull  PhoneAuthCredential phoneAuthCredential) {
              //To perform Auto Verification
                siginPhoneAuth(phoneAuthCredential);
            }
    ...
    private void siginPhoneAuth(PhoneAuthCredential phoneAuthCredential) {
